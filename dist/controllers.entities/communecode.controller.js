...
exports.getCommuneCode = void 0;
const types_1 = require("../types");
const CommuneCode_service_1 = require("../services/CommuneCode.service");
const ccService = new CommuneCode_service_1.CommuneCodeService();
const getCommuneCode = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        let commune_codes = yield ccService.getCommuneCodeByTypeZone(critere, code);
...
exports.getCommuneCode = getCommuneCode;
