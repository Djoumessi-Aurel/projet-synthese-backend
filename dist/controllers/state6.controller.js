...
const getState6 = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        let state6 = {
            ...
            code_zone: code,
            listeRessources: ressource.map((value) => { let res = new RessourceFauniqueDTO_1.RessourceFauniqueDTO(value); return res; }),
        };
