...
const state8Repository = app_1.AppDataSource.getRepository(entities_1.State8);
class State8Service {
    ...
    findAll() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield state8Repository.find();
        });
    }
    save(entity) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield state8Repository.save(entity);
        });
    }
}
exports.State8Service = State8Service;
